...
namespace ManagentCinemaSystem.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchTerm, string roleFilter, string statusFilter)
        {
            ...
            {
                usersQuery = usersQuery.Where(u => u.UserName.Contains(searchTerm, StringComparison.OrdinalIgnoreCase) ||
        ...
        public async Task<IActionResult> Create(UserCreateViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    case "Admin":
                        newUser = new ManagentCinemaSystem.Models.Admin { UserName = model.UserName, Email = model.Email, Name = model.Name, PhoneNumber = model.Phone, Status = model.Status, EmailConfirmed = true };
                        model.InitialRole = "Admin"; // Admins must have Admin role
                        break;
                    case "Staff":
                        newUser = new ManagentCinemaSystem.Models.Staff { UserName = model.UserName, Email = model.Email, Name = model.Name, PhoneNumber = model.Phone, Status = model.Status, EmailConfirmed = true };
                    ...
                    case "Customer":
                    default:
                        newUser = new ManagentCinemaSystem.Models.Customer { UserName = model.UserName, Email = model.Email, Name = model.Name, PhoneNumber = model.Phone, Status = model.Status, EmailConfirmed = false };
